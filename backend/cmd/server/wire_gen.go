...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	publicModelMarketplaceService := service.ProvidePublicModelMarketplaceService(channelService, groupRepository)
	modelMarketplaceHandler := handler.ProvideModelMarketplaceHandler(publicModelMarketplaceService)
