...
func ProvideModelMarketplaceHandler(marketplace *service.PublicModelMarketplaceService) *ModelMarketplaceHandler {
	return NewModelMarketplaceHandler(marketplace)
}
...
var ProviderSet = wire.NewSet(
	...
	ProvideModelMarketplaceHandler,
