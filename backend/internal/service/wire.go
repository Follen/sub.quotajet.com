...
// ProvidePublicModelMarketplaceService makes the optional group dependency
// explicit for Wire while preserving the constructor's lightweight test API.
func ProvidePublicModelMarketplaceService(channels availableChannelLister, groups GroupRepository) *PublicModelMarketplaceService {
	return NewPublicModelMarketplaceService(channels, groups)
}
...
var ProviderSet = wire.NewSet(
	...
	NewChannelService,
	wire.Bind(new(availableChannelLister), new(*ChannelService)),
	ProvidePublicModelMarketplaceService,
