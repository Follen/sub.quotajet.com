    ...
    >
      ...
      <div class="group/endpoint relative flex items-center gap-1.5">
        ...
        >
          ...
          <div class="absolute left-1/2 top-full h-3 w-3 -translate-x-1/2 -translate-y-1/2 rotate-45 border-b border-r border-slate-200 bg-white dark:border-dark-600 dark:bg-surface-popover"></div>
        </div>
