    ...
    >
      ...
      >
        ...
        <div v-if="copyAccountsGroupOptions.length > 0">
          <div class="mb-1.5 flex items-center gap-1">
            ...
            <div class="group relative inline-flex">
              ...
              >
                <div
                  class="rounded-lg bg-gray-900 p-3 text-white shadow-lg dark:bg-surface-popover"
                >
                  <p class="text-xs leading-relaxed text-gray-300">
                    {{ t("admin.groups.copyAccounts.tooltip") }}
                  </p>
                  <div
                    class="absolute -bottom-1.5 left-3 h-3 w-3 rotate-45 bg-gray-900 dark:bg-surface-popover"
                  ></div>
                </div>
              </div>
            </div>
            ...
            <div class="group relative inline-flex">
              ...
              >
                ...
                >
                  ...
                  <div class="rounded bg-gray-800 p-2 dark:bg-surface-accent">
                    <p class="text-xs leading-relaxed text-gray-300">
                      <span
        ...
        >
          ...
          <div class="mt-2 rounded-lg bg-gray-50 p-3 text-xs text-gray-700 dark:bg-dark-800 dark:text-gray-300">
