                      ...
                      <div>
                        ...
                        <div class="flex overflow-hidden rounded-lg border border-gray-300 bg-white focus-within:border-primary-500 focus-within:ring-1 focus-within:ring-primary-500 dark:border-dark-600 dark:bg-dark-900">
                          ...
                          <input
                            v-model="doc.id"
                            type="text"
                            class="min-w-0 flex-1 border-0 bg-transparent px-3 py-2 text-sm text-gray-900 outline-none placeholder:text-gray-400 focus:ring-0 dark:text-white dark:placeholder:text-content-muted"
                    ...
                    <button
                      ...
                      :class="[
                        ...
                        isPaymentTypeEnabled(pt.value)
                          ? 'border-primary-500 bg-primary-500 text-primary-50 shadow-sm'
                ...
                <div class="space-y-2">
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      <div
                        class="w-9 h-5 bg-gray-200 peer-focus:outline-none rounded-full peer dark:bg-dark-600 peer-checked:after:translate-x-full peer-checked:after:border-primary-50 peer-checked:after:bg-primary-50 after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all dark:after:border-gray-500 peer-checked:bg-primary-600"
                      ></div>
                    </label>
                    <input
                      v-model="entry.email"
...
.settings-tab-active::after {
  ...
  content: "";
  background: linear-gradient(90deg, oklch(var(--qj-primary-500)), oklch(var(--qj-primary-600)));
}
...
.dark .settings-tabs-shell {
  border-color: oklch(var(--qj-surface-accent) / 0.65);
  background: oklch(var(--qj-surface-card) / 0.92);
  box-shadow:
...
.dark .settings-tab::before {
  background: oklch(var(--qj-surface-accent) / 0.72);
}
