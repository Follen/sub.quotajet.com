      ...
      <div class="divide-y divide-gray-100 dark:divide-dark-800">
        ...
        >
          <div class="flex min-w-0 items-center gap-3">
            ...
            >
              <span
                class="pointer-events-none inline-block h-5 w-5 rounded-full shadow transition-transform duration-200 ease-in-out"
                :class="endpoint.enabled ? 'translate-x-5 bg-primary-50' : 'translate-x-0 bg-white dark:bg-dark-100'"
              />
            </button>
            <div class="min-w-0">
