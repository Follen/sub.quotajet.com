...
beforeAll(async () => {
  const contractConfig = {
    ...
    content: [
      {
        raw: '<main class="bg-surface-canvas text-content-muted"><aside class="sidebar"></aside><button class="btn btn-primary"><span class="rounded-full bg-white"></span></button></main>',
        extension: 'html'
      }
    ]
  } as Config
