export default {
  ...
  'Model detail navigation': 'Model detail navigation',
  ...
  Group: 'Group',
  Ratio: 'Ratio',
  'This model is not available in any public group.': 'This model is not available in any public group.',
  Type: 'Type',
  'No public performance data is available for this model.': 'No public performance data is available for this model.',
  'API endpoints': 'API endpoints',
  'Quick start': 'Quick start',
  'Call this model through the public Sub2API-compatible endpoint.': 'Call this model through the public Sub2API-compatible endpoint.',
  Copy: 'Copy',
  'Create API key': 'Create API key',
  'Replace $YOUR_API_KEY before sending the request.': 'Replace $YOUR_API_KEY before sending the request.',
  'Model not found': 'Model not found',
  "The model you're looking for doesn't exist.": "The model you're looking for doesn't exist.",
  'Back to Models': 'Back to Models',
  'Prices shown per request': 'Prices shown per request',
  Tags: 'Tags',
