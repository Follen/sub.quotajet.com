export default {
  ...
  'Clear filters': '清除筛选',
  Close: '关闭',
  'Filter models by provider, group, type, endpoint, and tags.': '按供应商、分组、计费类型、端点和标签筛选模型。',
  'Copy model name': '复制模型名称',
  Details: '详情',
  tokens: 'tokens',
  request: '次请求',
  'No description available.': '暂无模型说明。',
  Back: '返回',
  'Reference pricing': '参考定价',
  'Average latency': '平均延迟',
  'Success rate': '成功率',
  'Model detail navigation': '模型详情导航',
  Performance: '性能',
  API: 'API',
  'Text tokens': '文本 Token',
  Request: '请求',
  'Prices shown per': '价格单位',
  'Cache write': '缓存写入',
  'Pricing by Group': '分组定价',
  Group: '分组',
  Ratio: '倍率',
  'This model is not available in any public group.': '该模型当前不属于任何公开分组。',
  Type: '类型',
  'No public performance data is available for this model.': '该模型暂无公开性能数据。',
  'API endpoints': 'API 端点',
  'Quick start': '快速开始',
  'Call this model through the public Sub2API-compatible endpoint.': '通过公开的 Sub2API 兼容端点调用此模型。',
  Copy: '复制',
  'Create API key': '创建 API 密钥',
  'Replace $YOUR_API_KEY before sending the request.': '发送请求前请替换 $YOUR_API_KEY。',
  'Model not found': '未找到模型',
  "The model you're looking for doesn't exist.": '您访问的模型不存在。',
  'Back to Models': '返回模型广场',
  'Prices shown per request': '按次请求计价',
  Tags: '标签',
  'All Groups': '所有分组',
  Models: '模型广场',
  'Status check': '状态检查',
